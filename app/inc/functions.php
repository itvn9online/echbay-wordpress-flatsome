...
function _eb_echbay_sidebar( $slug, $css = '', $div = 'div', $in_cache = 1, $load_main_sidebar = 1, $return_null = 0 ) {
    ...
    if ( $a == '' ) {
        ...
        if ( $load_main_sidebar == 1 &&
            ...
            $slug != WGR_DEFAULT_SIDEBAR ) {
            $a = _eb_echbay_sidebar( WGR_DEFAULT_SIDEBAR, $css, $div, $in_cache );
...
include __DIR__ . '/functionsResizeImg.php';
include __DIR__ . '/functionsP2.php';
include __DIR__ . '/functionsP3.php';
include __DIR__ . '/functionsTemplate.php';
include __DIR__ . '/functionsWidget.php';